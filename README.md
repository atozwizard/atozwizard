...
### POMMIT
- `company_analyzer`의 `service_agent` 흐름을 중심으로 HTML 정리, 텍스트 정제, 단어 빈도 추출, collector 전달 구조를 정리했습니다.
...
- 무역 실무 온보딩 미니프로젝트에서 `RAG`와 `riskmanaging agent` 흐름을 중심으로 작업했습니다.
...
- [Notion Portfolio](https://adorable-brisket-aab.notion.site/328b8944c883810b81e8e09f8b770d82)
- [Public Resume Site](https://atozwizard.github.io/MasterResumeMR/)
- [MasterResumeMR](https://github.com/atozwizard/MasterResumeMR)
- [Gists](https://gist.github.com/atozwizard)
